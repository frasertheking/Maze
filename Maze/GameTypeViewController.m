...
- (void)viewDidLoad {
    ...
    self.rankedModeButton.center =  CGPointMake(self.view.center.x, self.view.center.y - 30);
    ...
    self.casualModeButton.center = CGPointMake(self.view.center.x, self.view.center.y + 40);
    ...
    self.tutorialModeButton.buttonColor = [UIColor ht_emeraldColor];
    self.tutorialModeButton.shadowColor = [UIColor ht_nephritisColor];
    ...
    [self.challengeModeButton setTitle:@"Multiplayer" forState:UIControlStateNormal];
